...
INSERT INTO `ciclos_cursos` VALUES (1,'08:00:00','10:00:00','lunes',9,1);
...
CREATE TABLE `grupos_por_ciclo` (
  ...
  KEY `fk_GRUPOS_PROFESORES1_idx` (`id_profesor`),
  ...
  CONSTRAINT `fk_GRUPOS_PROFESORES1` FOREIGN KEY (`id_profesor`) REFERENCES `profesores` (`id_profesor`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `grupos_por_ciclo` VALUES (1,'Ciclo Ciencias',1,1,1);
...
-- Dump completed on 2025-06-09 19:35:46
