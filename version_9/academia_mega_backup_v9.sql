...
INSERT INTO `especialidades` VALUES (1,'Ciencias de la Salud'),(2,'Ingeniería'),(3,'Matemática'),(4,'Ciencias Económicas'),(5,'Humanidades'),(6,'Ciencias Sociales'),(7,'Educación'),(8,'Derecho'),(9,'Psicología'),(10,'Arquitecturaaa'),(11,'Administración'),(12,'Comunicacion empresarial'),(13,'Computacion'),(14,'Ingles');
...
CREATE TABLE `grupos_por_ciclo` (
  ...
  KEY `fk_grupos_por_ciclo_ciclos_prog_idx` (`id_ciclo`),
  CONSTRAINT `fk_gpc_ciclos_prog` FOREIGN KEY (`id_ciclo`) REFERENCES `ciclos_programados` (`id_ciclo`),
...
INSERT INTO `sedes` VALUES (1,'Sede Miraflores A','Miraflores'),(2,'Sede Norte','Los Olivos'),(3,'Sede Sur','Chorrillos'),(4,'Sede Ate','Ate'),(5,'Sede Oeste','Callao'),(6,'Sede San Juan','San Juan de Lurigancho'),(7,'Sede Villa','Villa El Salvador'),(8,'Sede La Molina','La Molina'),(9,'Sede San Miguel','San Miguel'),(10,'Sede Independencia','Independencia'),(11,'Sede SJM','San Juan De Miraflores'),(12,'Sede Antiguo SJM','San Juan de Miraflores'),(13,'Sede NPab','Comas'),(14,'Sede Inviernito','Trujillo');
...
-- Dump completed on 2025-07-06  2:57:26
